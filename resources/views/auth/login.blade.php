    ...
    <div class="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div class="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
            <div>
                ...
                <h2 class="text-1x5 font-bold text-gray-700 mb-6 text-center transform translate-y-[-2rem]">Masuk Ke Akun Anda Sekarang</h2>
            </div>
            <form class="space-y-4" action="/masuk" method="POST">
                @csrf
                <div>
