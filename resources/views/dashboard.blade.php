...
@section('konten')
    <div class="container max-w-screen-lg mx-auto mt-10 grid grid-cols-5 items-center ">
        

<div class="w-50 max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
